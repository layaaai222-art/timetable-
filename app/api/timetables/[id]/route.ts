...
export async function GET(
  ...
  try {
    ...
    console.error(`GET /api/timetables/${params.id} failed:`, err);
...
export async function PUT(
  ...
  try {
    ...
    console.error(`PUT /api/timetables/${params.id} failed:`, err);
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    console.error(`DELETE /api/timetables/${params.id} failed:`, err);
    return NextResponse.json(
